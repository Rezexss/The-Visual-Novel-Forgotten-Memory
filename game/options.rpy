...
define config.name = _("forrgoten memory1")
...
Главная героиня начинает новую жизнь в незнакомом городе. Прошлое стерто, осталось только имя. В первый же день она устраивается бариста в небольшую кофейню, надеясь, что рутина поможет обрести почву под ногами.

Дорога от съемной квартиры до работы, утренняя суета, звон чашек и новые люди становятся ее реальностью. Коллеги и посетители невольно становятся проводниками в мир воспоминаний. Случайные фразы, забытая кем-то книга, старая фотография или знакомая мелодия вдруг выдергивают из пустоты смутные образы.

Ключами к прошлому служат три найденных предмета: пожелтевшая фотография, старый ключ от неизвестной двери и детская плюшевая игрушка в виде зайца. Каждый из них открывает фрагмент той жизни, от которой героиня, сама того не зная, пыталась убежать.

Чем больше всплывает деталей, тем сложнее их принять. Прошлое пугает и заставляет сомневаться: готова ли она вернуться к той, кем была когда-то?

Перевод: Английский, русский

Тестировщик: fantom
 
Звуковые эффекты: Freesound.org, Pixabay.com
...
define build.name = "forgotenmemory"
...
define config.main_menu_music = "audio/main_misic.ogg"
...
define config.save_directory = "forrgotenmemory1-1772765920"
