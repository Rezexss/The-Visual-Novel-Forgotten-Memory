...
style button:
    ...
    activate_sound "audio/cka.ogg"
    hover_sound "audio/click.ogg"
style button_text is gui_text:
    properties gui.text_properties("button")
    yalign 0.5
init python:
    style.image_button.hover_sound = "audio/click.ogg"
    style.image_button.activate_sound = "audio/cka.ogg"
...
screen main_menu():
    ...
    frame:
        style "main_menu_container"

        # Правая колонка с кнопками
        frame:
            style "main_menu_right"

            vbox:
                style "main_menu_buttons_vbox"
    ...
    # Версия игры внизу
    frame:
        style "main_menu_version_frame"
        text _("Версия 1.0") style "main_menu_version_text"
...
style main_menu_right:
    ...
    yoffset 100  # Смещение вниз на 100 пикселей от центра
    xsize 400
    ysize None  # Автоматическая высота
    background None
...
style game_menu_navigation_frame:
    xsize 420
    yfill True
    yoffset -100  # Добавлено для поднятия кнопок в игровом меню выше
...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            ## Блок с логотипом/картинкой и названием
            hbox:
                xalign 0.5
                spacing 20

                # Картинка (замените "logo_image.png" на ваш файл)
                #add "logo_image.png" zoom 0.5

                #vbox:
                    #label "[config.name!t]"
                    #text _("Версия [config.version!t]") style "about_version"
            ...
            vbox:
                spacing 15
                label _("Мои соцсети:") style "about_header"

                # Ссылка на VK
                hbox:
                    spacing 10
                    # Иконка VK (замените "vk_icon.png" на ваш файл)
                    #add "vk_icon.png" zoom 0.3
                    textbutton _("ВКонтакте") action OpenURL("https://vk.com/your_page") style "about_social_button"

                # Ссылка на Telegram
                hbox:
                    spacing 10
                    # Иконка Telegram (замените "tg_icon.png" на ваш файл)
                    #add "tg_icon.png" zoom 0.3
                    textbutton _("Telegram") action OpenURL("https://t.me/your_channel") style "about_social_button"
...
style about_version is about_text
style about_header is about_label
style about_social_button is button
style about_social_button_text is button_text
style about_blurb is about_text
...
style about_social_button:
    xpadding 20
    ypadding 5
    background "#333333"
    hover_background "#444444"

style about_social_button_text:
    size gui.text_size
    color "#FFFFFF"
    hover_color "#AAAAAA"
